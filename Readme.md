...
`main` - at parity with our production site https://docs.amplify.aws/ `gh-pages` - used to handle redirects from v1 of the documentation site. This should not be deleted.
